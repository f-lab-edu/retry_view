...
public class EventService {
    ...
    public EventDTO saveEvent(WriteEventRequest req){
        Event event = Event.newEventFromReq(req);
        List<EventImage> images = req.getImages().stream().map(img -> EventImage.getEventImage(img.getId(), img.getImageUrl(), req.getCreatedBy())).toList();
    ...
    public EventDTO updateEvent(WriteEventRequest req){
        ...
        List<EventImage> reqImages = req.getImages().stream().map(img -> EventImage.getEventImage(img.getId(), img.getImageUrl(), req.getCreatedBy())).toList();
